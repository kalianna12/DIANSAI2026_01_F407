...
#define AD9854_UCLK_PIN        GPIO_PIN_4
#define AD9854_WR_PIN          GPIO_PIN_5
#define AD9854_RD_PIN          GPIO_PIN_8
#define AD9854_OSK_PIN         GPIO_PIN_2
#define AD9854_FSK_PIN         GPIO_PIN_10
...
{
    uint32_t value = ((uint32_t)(addr & 0x3FU) << 8) | data;
...
void AD9854_IO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOA,
                      AD9854_RST_PIN | AD9854_UCLK_PIN | AD9854_WR_PIN |
                          AD9854_RD_PIN | AD9854_OSK_PIN,
                      GPIO_PIN_RESET);
    HAL_GPIO_WritePin(GPIOB, AD9854_FSK_PIN, GPIO_PIN_RESET);
